<template>
  <div class="md:p-5 md:pl-0 pointer-events-none">
    <div class="h-full flex pointer-events-none transition duration-300">
      <div
        class="relative hidden md:block z-10 w-14 backdrop-blur-md pointer-events-auto transition-all duration-300"
        :class="[collapsed ? 'md:rounded-r-2xl md:bg-purple-main/20' : 'md:bg-white/70 ']"
      >
    ...
    C42.677,47.979,42.567,48.054,42.459,48.132z"
      ...
      <div
        class="relative p-5 w-full md: md:pl-[84px] bg-white/70 transition duration-300 rounded-r-2xl pointer-events-auto overflow-hidden"
